...
class TestSubsystem(StatTestCase):
    ...
    def test_output(self):
        ...
        ship_item = self.ch.type_(type_id=1, attributes={Attribute.subsystem_slot: 2})
    ...
    def test_use_empty(self):
        self.assertEqual(self.st.subsystem_slots.used, 0)
        self.assertEqual(len(self.log), 0)
        self.assert_stat_buffers_empty()
    ...
    def test_volatility(self):
        ...
        self.assertEqual(self.st.subsystem_slots.used, 1)
        self.assertEqual(self.st.subsystem_slots.total, 4)
        self.set_ship(None)
        self.assertEqual(len(self.log), 0)
        self.assert_stat_buffers_empty()
