...
class TestLowSlot(RestrictionTestCase):
    ...
    def test_fail_excess_signle(self):
        ...
        holder = Mock(state=State.offline, item=item, _domain=Domain.ship, spec_set=Module(1))
    ...
    def test_fail_excess_multiple(self):
        ...
        restriction_error1 = self.get_restriction_error(holder1, Restriction.low_slot)
    ...
    def test_fail_excess_multiple_with_nones(self):
        ...
        self.fit.modules.low.append(holder2)
        self.fit.modules.low.append(None)
        self.fit.modules.low.append(holder3)
        self.fit.stats.low_slots.used = 7
        self.fit.stats.low_slots.total = 3
        restriction_error1 = self.get_restriction_error(holder1, Restriction.low_slot)
        self.assertIsNone(restriction_error1)
        restriction_error2 = self.get_restriction_error(holder2, Restriction.low_slot)
        self.assertIsNotNone(restriction_error2)
        ...
        restriction_error3 = self.get_restriction_error(holder2, Restriction.low_slot)
    ...
    def test_pass_equal(self):
        ...
        self.fit.modules.low.append(holder2)
        self.fit.stats.low_slots.used = 2
        self.fit.stats.low_slots.total = 2
        restriction_error1 = self.get_restriction_error(holder1, Restriction.low_slot)
        self.assertIsNone(restriction_error1)
        restriction_error2 = self.get_restriction_error(holder2, Restriction.low_slot)
    ...
    def test_pass_greater(self):
        ...
        self.fit.modules.low.append(holder2)
        self.fit.stats.low_slots.used = 2
        self.fit.stats.low_slots.total = 5
        restriction_error1 = self.get_restriction_error(holder1, Restriction.low_slot)
        self.assertIsNone(restriction_error1)
        restriction_error2 = self.get_restriction_error(holder2, Restriction.low_slot)
        self.assertIsNone(restriction_error2)
